const content = [
  {
    ...
    image: "src/assets/cardMinimal.png",
    logo: "src/assets/W_LOGO2.svg",
    borderColor: "red",
    buttonText: "WHTY SHOP",
    hoverImage: "src/assets/cardMinimalHover.png",
  },
  {
    id: 2,
    title: "STREET ALIENS",
    ...
    image: "src/assets/cardMinimal2.png",
    logo: "src/assets/STREETALIENS.png",
    buttonText: "ALIENS SHOP",
    borderColor: "#399caf",
    hoverImage: "src/assets/cardMinimal2Hover.png",
  },
  {
    id: 3,
    title: "WHITEDEMON",
    ...
    image: "src/assets/cardMinimal3.png",
    logo: "src/assets/W_LOGO.svg",
    borderColor: "pink",
    buttonText: "FASION SHOP",
    hoverImage: "src/assets/cardMinimal3Hover.png",
  },
];
